#include<iostream> 
#include<conio.h> //We have used getch() command which will help us to hold the output screen by taking dummy input from the user
#include<string>
using namespace std;
...
inline void increment(int &counter1){
	counter1++;
}

//function for decrementing counter
inline void decrement(int &counter1){
	counter1--;
}
